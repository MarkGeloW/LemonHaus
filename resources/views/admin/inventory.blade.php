        ...
        <div class="max-w-[1440px]">
            ...
            <div class="flex justify-between items-start mb-8">
                ...
                <div class="flex gap-3">
                    <a href="{{ route('admin.products.create') }}"
                       class="bg-[#f4c400] hover:bg-[#eab308] text-black font-semibold px-7 py-4 rounded-2xl text-[18px] transition shadow-sm">
                        + Add Product
                    </a>

                    <a href="{{ route('admin.stocks.create') }}"
                       class="bg-[#B7E6D8] hover:bg-[#9ddcca] text-[#37554d] font-semibold px-7 py-4 rounded-2xl text-[18px] transition shadow-sm">
                        + Add Stock
                    </a>
                </div>
            </div>
            ...
            <div class="grid grid-cols-4 gap-5 mb-7">
                <div class="bg-white rounded-[22px] border border-[#e9edf3] shadow-sm p-7">
                    <p class="text-[16px] text-[#64748b] font-medium">
                        Stock Items
                    </p>

                    <h2 class="text-[28px] font-extrabold text-[#0f172a] mt-2">
                        {{ $stocks->count() }}
                    </h2>
                </div>
                ...
                <div class="bg-white rounded-[22px] border border-[#e9edf3] shadow-sm p-7">
                    ...
                    <h2 class="text-[28px] font-extrabold text-red-500 mt-2">
            ...
            <div class="bg-white rounded-[24px] border border-[#e9edf3] overflow-hidden shadow-sm mb-10">
                <div class="px-8 py-6 border-b border-[#eef2f7] flex items-center justify-between">
                    <div>
                        <h2 class="text-[26px] font-extrabold text-[#0f172a]">
                            Stocks
                        </h2>
                    ...
                    <span class="bg-[#e5fbf5] text-[#37554d] px-5 py-2 rounded-full font-bold">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        <thead class="bg-[#f8fafc] text-[#64748b] text-left">
                            <tr>
                                <th class="px-8 py-6">STOCK NAME</th>
                                <th class="px-8 py-6">CATEGORY</th>
                                <th class="px-8 py-6">STOCK LEVEL</th>
                                <th class="px-8 py-6">MIN STOCK</th>
                                <th class="px-8 py-6">EXPIRATION DATE</th>
                        ...
                        <tbody class="divide-y divide-[#eef2f7]">
                            @forelse($stocks as $stock)
                                ...
                                <tr class="hover:bg-[#f8fafc] transition">
                                    <td class="px-8 py-6 font-bold text-[#0f172a]">
                                        {{ $stock->name }}
                                    </td>

                                    <td class="px-8 py-6 text-[#334155]">
                                        {{ $stock->category }}
                                    </td>

                                    <td class="px-8 py-6 font-bold {{ $isOut ? 'text-red-500' : ($isLow ? 'text-orange-500' : 'text-green-600') }}">
                                        {{ $stock->stock_level }}
                                    ...
                                    <td class="px-8 py-6 font-bold {{ $isExpired ? 'text-red-500' : 'text-[#334155]' }}">
            ...
            <div class="bg-white rounded-[24px] border border-[#e9edf3] overflow-hidden shadow-sm">
                <div class="px-8 py-6 border-b border-[#eef2f7] flex items-center justify-between">
                    ...
                    <span class="bg-[#fff7cc] text-[#8a6a00] px-5 py-2 rounded-full font-bold">
                                ...
                                <tr class="hover:bg-[#f8fafc] transition">
                                    <td class="px-8 py-6">
                                        ...
                                        @if($product->description)
                                            <div class="text-sm text-[#64748b] mt-1">
                                                {{ $product->description }}
                                            </div>
                                        @endif
                                    </td>
