    ...
    <div>
        ...
        <nav class="px-4 py-6 space-y-3">
            <a href="{{ route('dashboard') }}"
               onclick="closeAdminSidebar()"
               class="sidebar-link {{ request()->routeIs('dashboard') ? 'active-sidebar' : '' }}">
            ...
            <a href="{{ route('admin.orders.index') }}"
               onclick="closeAdminSidebar()"
               class="sidebar-link {{ request()->routeIs('admin.orders.index') ? 'active-sidebar' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
            ...
            <a href="{{ route('admin.kitchen') }}"
               onclick="closeAdminSidebar()"
               class="sidebar-link {{ request()->routeIs('admin.kitchen') ? 'active-sidebar' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
            ...
            <a href="{{ route('admin.inventory') }}"
               onclick="closeAdminSidebar()"
               class="sidebar-link {{ request()->routeIs('admin.inventory') ? 'active-sidebar' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
            ...
            <a href="{{ route('reports.index') }}"
               onclick="closeAdminSidebar()"
               class="sidebar-link {{ request()->routeIs('reports.index') ? 'active-sidebar' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
            ...
            <a href="{{ route('admin.index') }}"
               onclick="closeAdminSidebar()"
               class="sidebar-link {{ request()->routeIs('admin.index') ? 'active-sidebar' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
...
<div id="logout-modal" class="fixed inset-0 z-[120] hidden flex items-center justify-center bg-[#0f172a]/70 backdrop-blur-sm transition-opacity duration-300 opacity-0">
