        ...
        <div class="max-w-[1420px]">
            ...
            <div class="grid grid-cols-[1.9fr_0.9fr] gap-6">
                ...
                <div class="bg-white rounded-[24px] border border-[#e9edf3] shadow-sm p-7">
                    <h2 class="text-[22px] font-bold text-[#0f172a] mb-8">
                        ...
                        <div class="absolute inset-0 flex items-end justify-between px-10 lg:px-20 pb-10 pt-10">
                            @forelse($weeklySalesData ?? collect() as $bar)
                                <div class="flex flex-col items-center justify-end gap-3 group relative w-full">
                                    ...
                                    <span class="text-[14px] md:text-[16px] text-[#64748b] font-medium">
                                        {{ $bar['day'] }}
                                    </span>
                                </div>
                            @empty
                ...
                <div class="bg-white rounded-[24px] border border-[#e9edf3] shadow-sm p-7">
                    <h2 class="text-[22px] font-bold text-[#0f172a] mb-6">
                        Low Stock Alerts
                    </h2>

                    @if(($lowStockItems ?? collect())->isEmpty())
                        <p class="text-[16px] text-[#16a34a] mb-12 font-semibold">
                    ...
                    <h3 class="text-[20px] font-bold text-[#0f172a] mb-5">
                        Recent Activity
                    </h3>
